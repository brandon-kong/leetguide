...
const LandingHeading = ({ className, children }: TypographyProps) => {
    return (
        <h1 className={cn("font-sans scroll-m-20 text-4xl font-bold tracking-loose lg:leading-10 lg:text-6xl", className)}>
            {children}
        </h1>
    );
};
...
const H1 = ({ className, children }: TypographyProps) => {
    return (
        <h1 className={cn("font-sans scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl", className)}>
            {children}
        </h1>
    );
};
...
const H2 = ({ className, children }: TypographyProps) => {
    return (
        <h2 className={cn("font-sans scroll-m-20 text-3xl font-semibold tracking-tight first:mt-0", className)}>
            {children}
        </h2>
    );
};
...
const H3 = ({ className, children }: TypographyProps) => {
    return (
        <h3 className={cn("font-sans scroll-m-20 text-3xl font-semibold tracking-tight", className)}>
            {children}
        </h3>
    );
};
